...
# $Header: /var/cvsroot/gentoo-x86/dev-scheme/racket/racket-6.0.1.ebuild,v 1.2 2014/08/10 21:25:26 slyfox Exp $
...
SRC_URI="minimal? ( http://mirror.racket-lang.org/installers/${PV}/${PN}-minimal-${PV}-src-builtpkgs.tgz ) !minimal? ( http://mirror.racket-lang.org/installers/${PV}/${P}-src-builtpkgs.tgz )"
EGIT_REPO_URI="https://github.com/plt/racket.git"
